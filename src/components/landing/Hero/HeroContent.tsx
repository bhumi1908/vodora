...
export function HeroContent() {
  ...
  return (
    <div className="flex flex-col gap-6 sm:gap-7">
      ...
      <AnimateIn immediate delay={120} variant="fade-up">
        <p className="max-w-md text-md leading-relaxed text-white sm:max-w-2xl sm:text-xl">
          {HERO_CONTENT.description}
        </p>
      </AnimateIn>

      <AnimateIn immediate delay={220} variant="fade-up">
      ...
      <AnimateIn immediate delay={320} variant="fade-up">
        <HeroStats />
      </AnimateIn>
    </div>
  );
...
function HeroStats() {
  return (
    <div className="flex items-center gap-3">
      ...
      <p className="text-md text-gray-300">{HERO_CONTENT.socialProof}</p>
    </div>
  );
}
