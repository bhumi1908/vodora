...
export function WorkStyleSection() {
  return (
    <section
      ...
      className={` mx-auto max-w-screen-2xl overflow-x-hidden bg-white py-12 sm:py-16 lg:py-20 ${poppins.className}`}
    >
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-8 xl:gap-12">
          <div className="w-full shrink-0 lg:max-w-[38%] xl:max-w-[420px]">
