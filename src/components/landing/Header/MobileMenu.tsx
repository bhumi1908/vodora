  ...
  return (
    <>
      <button
        ...
        onClick={onClose}
      />
      <div className="absolute right-0 left-0 z-50 max-h-[calc(100dvh-4rem)] overflow-y-auto bg-black shadow-2xl md:hidden">
        <nav
          ...
          <div className="space-y-1">
            {items.map((item) => (
              <Link
                ...
                href={item.href}
                onClick={onClose}
                className={`block rounded-md px-4 py-3 text-sm font-semibold uppercase tracking-widest transition-colors ${
