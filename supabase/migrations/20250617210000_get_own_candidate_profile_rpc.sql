-- Single RPC to load the authenticated candidate's full profile in one round trip.
...
GRANT EXECUTE ON FUNCTION public.get_own_candidate_profile() TO authenticated;
