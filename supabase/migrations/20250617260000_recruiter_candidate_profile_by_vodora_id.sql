-- Look up recruiter-visible candidate profiles by public vodora_id instead of internal UUID.

DROP FUNCTION IF EXISTS public.get_recruiter_candidate_profile(UUID);
