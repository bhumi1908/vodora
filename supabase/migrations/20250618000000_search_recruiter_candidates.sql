-- Recruiter candidate search with pagination and filters.
...
-- Filter metadata for recruiter search (countries + directory count).
...
REVOKE ALL ON FUNCTION public.get_recruiter_search_metadata() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_recruiter_search_metadata() TO authenticated;
